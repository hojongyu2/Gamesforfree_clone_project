...
export default function LoginPage() {
    ...
    const onChangePassword = (e) => {
        setUserLoginInfo((prevState) => ({...prevState, password: e.target.value}))
    }
            ...
            <form onSubmit={(e)=> onSubmitLogin(e, userLoginInfo)}>
                <Container sx={{ display:'flex', flexDirection:'row'}}>
                    ...
                    <Box sx={{ display:'flex', flexDirection:'column', width: '100%', backgroundColor: 'primary.light', gap:2}}>
                        ...
                        {!errorMessage && <Typography sx={{ textAlign:'center'}}>Log in to FreeToGame</Typography>}
                        ...
                        <TextField onChange={onChangePassword} type='password' label="Password" InputProps={{sx: {color: 'white'}}} InputLabelProps={{sx: {color: 'white' }}} sx={{ color:'white', backgroundColor: 'primary.dark'}} required/>
                        <Button type='submit' sx={{backgroundColor:'primary', border:'solid'}}>Login</Button>
