            ...
            <form>
                <Container sx={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', backgroundColor: 'primary.light', gap: 2 }}>
                        <Typography sx={{ textAlign:'center'}}>Create My Account!</Typography>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', }}>
                            ...
                            <TextField onChange={onChangeConfirmPassword} InputProps={{ sx: { color: 'white' } }} InputLabelProps={{ sx: { color: 'white' } }} label="Confirm Password" sx={{ color: 'white', backgroundColor: 'primary.dark' }} />
                        </Box>
                        <Box sx={{ mt: 2 }}>
                        ...
                        <Button sx={{ backgroundColor: 'primary', border: 'solid' }}>Create Account</Button>
                        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', }}>
