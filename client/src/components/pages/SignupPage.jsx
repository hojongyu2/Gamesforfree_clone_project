...
export default function Signup() {
    ...
    const onChangeEmail = (e) => {
        ...
        //functional update that receives the previous state as an argument, then return a new object with the updated property.
    ...
    const handleFileChange = (e) => {
        ...
        setUserRegistrationInfo((prevState) => ({...prevState, profile_pic: e.target.value[0]}))
    };
            ...
            <form onSubmit={(e) => onSubmitSignIn(e, userRegistrationInfo)}>
                <Container sx={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', backgroundColor: 'primary.light', gap: 2 }}>
                        ...
                        <TextField type="email" onChange={onChangeEmail} InputProps={{ sx: { color: 'white' } }} InputLabelProps={{ sx: { color: 'white' } }} label="Email Address" sx={{ color: 'white', backgroundColor: 'primary.dark' }} />
                        <TextField onChange={onChangeFirstName} InputProps={{ sx: { color: 'white' } }} InputLabelProps={{ sx: { color: 'white' } }} label="Fisrt Name" sx={{ color: 'white', backgroundColor: 'primary.dark' }} />
                        <TextField onChange={onChangeLastName} InputProps={{ sx: { color: 'white' } }} InputLabelProps={{ sx: { color: 'white' } }} label="Last Name" sx={{ color: 'white', backgroundColor: 'primary.dark' }} />
                        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', }}>
                            <TextField type="password" onChange={onChangePassword} InputProps={{ sx: { color: 'white' } }} InputLabelProps={{ sx: { color: 'white' } }} label="Password" sx={{ color: 'white', backgroundColor: 'primary.dark' }} />
                            <TextField type="password" onChange={onChangeConfirmPassword} InputProps={{ sx: { color: 'white' } }} InputLabelProps={{ sx: { color: 'white' } }} label="Confirm Password" sx={{ color: 'white', backgroundColor: 'primary.dark' }} />
                        </Box>
                        <Box sx={{ mt: 2 }}>
                            <label htmlFor="profilePicture">
                                <Input onChange={handleFileChange} accept="image/*" id="profilePicture" name="profilePicture" type="file" />
